...
class AddMovie extends Component {
 ...
 const { title, genre, language, country } = this.props.movie;
 this.setState({ title, genre, language, country });
 }
 }
